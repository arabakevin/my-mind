...
MM.Map.prototype.center = function() {
  ...
  var left = ((port[0] - node.offsetWidth)/2) - 300;
  var top = (port[1] - node.offsetHeight)/2 - 100;
...
MM.UI.Backend.init = function(select) {
  ...
  // this._save_mind_map = this._node.querySelector(".button_save");
  // this._save_mind_map.addEventListener("click", this);
